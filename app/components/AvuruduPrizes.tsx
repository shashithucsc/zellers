  ...
  return (
    <section className="relative py-32 px-4 overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 items-center justify-center px-4 sm:px-8">
            ...
            >
              ...
              <div className="relative h-full overflow-hidden bg-white/5 backdrop-blur-2xl border border-white/10 group-hover:border-yellow-400/50 rounded-[2rem] p-8 md:p-12 text-center transition-all duration-700 ease-out hover:-translate-y-3 shadow-[0_15px_40px_rgba(0,0,0,0.4)] group-hover:shadow-[0_30px_60px_rgba(234,179,8,0.2)]">
                ...
                <div className="relative flex justify-center mb-8 mt-2">
                  ...
                  <div className="relative w-24 h-24 bg-gradient-to-b from-yellow-400/10 to-transparent border border-yellow-500/30 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-700 shadow-[inset_0_0_20px_rgba(234,179,8,0.15)] rotate-3 group-hover:rotate-0">
                    <prize.icon className="w-12 h-12 text-yellow-400 drop-shadow-[0_0_15px_rgba(234,179,8,0.6)]" strokeWidth={1.5} />
                  </div>
                </div>
                ...
                <div className="py-8 relative group/amount">
                  ...
                  <div className={`relative inline-block`}>
                     {/* The amount text */}
                     <span className={`text-5xl md:text-6xl font-black tracking-tighter text-transparent bg-clip-text bg-gradient-to-b ${prize.accent} drop-shadow-[0_2px_15px_rgba(234,179,8,0.3)] group-hover:drop-shadow-[0_5px_25px_rgba(234,179,8,0.6)] transition-all duration-700 block transform group-hover:scale-105`}>
                       {prize.amount}
                     </span>
