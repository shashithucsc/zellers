  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3">
        <Link
          href="/vote"
          className="text-sm font-semibold tracking-widest text-gray-300 hover:text-yellow-400 transition-colors duration-200 px-4 py-2 rounded-full hover:bg-white/5"
        >
          VOTE
        </Link>
        <Link
